	        ...
	        $('#myfm').form('submit',{
	            ...
	            success: function(result){
	                ...
	                if (result.iserror){
	                	...
	                	top.framework.closeAndReloadTab('新增角色', '<%=menuName%>');
	                }
	            }
	        });
		}
...
<body class="easyui-layout">
	...
	<div id="dlg" style="padding:10px 20px">
	   ...
	   <form id="myfm" method="post" novalidate>
	   	   ...
	   	   <table cellpadding="5">
                <tr>
                    <td>角色名称:</td>
                    <td><input class="easyui-validatebox" type="text" name="tsysrole.name" data-options="required:true,validType:'length[3,32]'"></input></td>
                </tr>
                <tr>
                    <td>类型:</td>
                    <td>
                ...
                <tr>
                	<td>描述:</td>
                    <td colspan="3">
                    <textarea id="description"  name="tsysrole.description" style="width:360px;height:60px;" ></textarea>
                    </td>
                </tr>
                <tr>
                    <td>状态:</td>
    ...
    <div data-options="region:'south'" style="height: 50px;" border="false">
		...
		<div style="text-align:center;padding:5px">
            ...
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="top.framework.closeTab('新增角色')">关闭</a>
    	</div>
	</div>
</body>
</html>
